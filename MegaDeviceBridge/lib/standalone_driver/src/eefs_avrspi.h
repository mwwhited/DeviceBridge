...
//#define RAM0		FRAM_MB85RS64V
#define RAM1		FRAM_MB85RS64V
...
#define RAM0_PAGE_ACCESS					// Device has Page Access
#define RAM0_PAGE_BYTES			32			// Bytes per Page
#endif
#if ( RAM1 == SRAM_23LC1024 )
#define RAM1_ADDR_BITS			17
#define RAM1_PAGE_ACCESS					// Device has Page Access
...
// SPI Slave Select lines are Port B0 and B1 respectively xxx changed the SS lines for testing
#define RAM_PORT	PORTB
#define RAM_DDR		DDRB
#define RAM0_SS		PORTB0
#define RAM1_SS		PORTB1
