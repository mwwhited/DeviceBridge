...
namespace RTOS {
  ...
  constexpr uint16_t PARALLEL_PORT_STACK = 256;
  constexpr uint16_t FILE_MANAGER_STACK = 512;
  constexpr uint16_t DISPLAY_STACK = 256;
  constexpr uint16_t TIME_STACK = 128;
  constexpr uint16_t SYSTEM_MONITOR_STACK = 128;

  // Queue sizes
  constexpr uint8_t DATA_QUEUE_SIZE = 8;
  constexpr uint8_t DISPLAY_QUEUE_SIZE = 4;
